...
<script>
import SecondAndMinute from "~/components/CronExpression/cron/secondAndMinute.vue";
import day from "~/components/CronExpression/cron/day.vue";
import month from "~/components/CronExpression/cron/month.vue";
import week from "~/components/CronExpression/cron/week.vue";
import year from "~/components/CronExpression/cron/year.vue";
import hour from "~/components/CronExpression/cron/hour.vue";
